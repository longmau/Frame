package com.yunwei.frame.widget.bottomnavigation;
...
import com.yunwei.frame.widget.bottomnavigation.behaviour.BottomNavBarFabBehaviour;
import com.yunwei.frame.widget.bottomnavigation.behaviour.BottomVerticalScrollBehavior;
import com.yunwei.frame.widget.bottomnavigation.utils.Utils;
...
//            mElevation =typedArray.getInt(R.styleable.BottomNavigationBar_bnbElevation, R.dimen.bottom_navigation_elevation);
...
//    }
     ...
     */
    public BottomNavigationBar addItem(int position, BottomNavigationItem item) {
        mBottomNavigationItems.add(position, item);
        return this;
    }
     ...
     * @update Date:2016-11-24
     */
    public BottomNavigationBar removeItem(int position) {
        mBottomNavigationItems.remove(position);
        return this;
    }

    /**
     * 返回添加的BottoNavigationItem集合
     *
     * @return
     * @update author:吴和志
     * @update Date:2016-11-24
     */
    public List<BottomNavigationItem> getItem() {
    ...
    public BottomNavigationItem getItem(int position) {
        if (mBottomNavigationItems != null && mBottomNavigationItems.size() >= position) {
