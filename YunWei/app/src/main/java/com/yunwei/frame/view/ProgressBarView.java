...
public class ProgressBarView extends View {
    ...
    private void init(Context context) {
        DEFULT_ARC_COLOR = getResources().getColor(R.color.colorAccent);
        arcPaint = new Paint();
    ...
    private void initAttributeset(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.IProgressAttr, defStyle, 0);
        arcColor = typedArray.getColor(R.styleable.IProgressAttr_IarcColor, Color.BLUE);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.IProgressAttr_IborderWidth, resources.getDimensionPixelSize(R.dimen.progress_border_idth));
    ...
    private int DEFULT_ARC_COLOR = Color.BLUE;
