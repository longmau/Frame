...
/**
 * DAO for table "MAP_LAYER19".
*/
public class MapLayer19Dao extends AbstractDao<MapLayer19, Void> {

    public static final String TABLENAME = "MAP_LAYER19";

    /**
     * Properties of entity MapLayer19.<br/>
    ...
    */
    ...
    public MapLayer19Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer19Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER19\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER19\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer19 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer19 readEntity(Cursor cursor, int offset) {
        MapLayer19 entity = new MapLayer19( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer19 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer19 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer19 entity) {
        return null;
    }
