...
/**
 * DAO for table "MAP_LAYER9".
*/
public class MapLayer9Dao extends AbstractDao<MapLayer9, Void> {

    public static final String TABLENAME = "MAP_LAYER9";

    /**
     * Properties of entity MapLayer9.<br/>
    ...
    */
    ...
    public MapLayer9Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer9Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER9\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER9\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer9 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer9 readEntity(Cursor cursor, int offset) {
        MapLayer9 entity = new MapLayer9( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer9 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer9 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer9 entity) {
        return null;
    }
