...
/**
 * DAO for table "MAP_LAYER15".
*/
public class MapLayer15Dao extends AbstractDao<MapLayer15, Void> {

    public static final String TABLENAME = "MAP_LAYER15";

    /**
     * Properties of entity MapLayer15.<br/>
    ...
    */
    ...
    public MapLayer15Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer15Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER15\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER15\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer15 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer15 readEntity(Cursor cursor, int offset) {
        MapLayer15 entity = new MapLayer15( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer15 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer15 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer15 entity) {
        return null;
    }
