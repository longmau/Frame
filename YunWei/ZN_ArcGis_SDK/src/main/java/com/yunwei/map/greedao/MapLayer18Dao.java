...
/**
 * DAO for table "MAP_LAYER18".
*/
public class MapLayer18Dao extends AbstractDao<MapLayer18, Void> {

    public static final String TABLENAME = "MAP_LAYER18";

    /**
     * Properties of entity MapLayer18.<br/>
    ...
    */
    ...
    public MapLayer18Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer18Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER18\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER18\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer18 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer18 readEntity(Cursor cursor, int offset) {
        MapLayer18 entity = new MapLayer18( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer18 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer18 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer18 entity) {
        return null;
    }
