...
/**
 * DAO for table "MAP_LAYER2".
*/
public class MapLayer2Dao extends AbstractDao<MapLayer2, Void> {

    public static final String TABLENAME = "MAP_LAYER2";

    /**
     * Properties of entity MapLayer2.<br/>
    ...
    */
    ...
    public MapLayer2Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer2Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER2\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER2\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer2 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer2 readEntity(Cursor cursor, int offset) {
        MapLayer2 entity = new MapLayer2( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer2 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer2 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer2 entity) {
        return null;
    }
