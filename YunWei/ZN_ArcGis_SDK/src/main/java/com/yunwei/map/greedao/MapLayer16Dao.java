...
/**
 * DAO for table "MAP_LAYER16".
*/
public class MapLayer16Dao extends AbstractDao<MapLayer16, Void> {

    public static final String TABLENAME = "MAP_LAYER16";

    /**
     * Properties of entity MapLayer16.<br/>
    ...
    */
    ...
    public MapLayer16Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer16Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER16\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER16\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer16 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer16 readEntity(Cursor cursor, int offset) {
        MapLayer16 entity = new MapLayer16( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer16 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer16 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer16 entity) {
        return null;
    }
