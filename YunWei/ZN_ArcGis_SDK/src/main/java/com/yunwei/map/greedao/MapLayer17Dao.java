...
/**
 * DAO for table "MAP_LAYER17".
*/
public class MapLayer17Dao extends AbstractDao<MapLayer17, Void> {

    public static final String TABLENAME = "MAP_LAYER17";

    /**
     * Properties of entity MapLayer17.<br/>
    ...
    */
    ...
    public MapLayer17Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer17Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER17\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER17\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer17 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer17 readEntity(Cursor cursor, int offset) {
        MapLayer17 entity = new MapLayer17( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer17 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer17 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer17 entity) {
        return null;
    }
