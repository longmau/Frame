...
/**
 * DAO for table "MAP_LAYER13".
*/
public class MapLayer13Dao extends AbstractDao<MapLayer13, Void> {

    public static final String TABLENAME = "MAP_LAYER13";

    /**
     * Properties of entity MapLayer13.<br/>
    ...
    */
    ...
    public MapLayer13Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer13Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER13\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER13\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer13 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer13 readEntity(Cursor cursor, int offset) {
        MapLayer13 entity = new MapLayer13( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer13 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer13 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer13 entity) {
        return null;
    }
