...
/**
 * DAO for table "MAP_LAYER7".
*/
public class MapLayer7Dao extends AbstractDao<MapLayer7, Void> {

    public static final String TABLENAME = "MAP_LAYER7";

    /**
     * Properties of entity MapLayer7.<br/>
    ...
    */
    ...
    public MapLayer7Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer7Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER7\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER7\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer7 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer7 readEntity(Cursor cursor, int offset) {
        MapLayer7 entity = new MapLayer7( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer7 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer7 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer7 entity) {
        return null;
    }
