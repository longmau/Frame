...
/**
 * DAO for table "MAP_LAYER12".
*/
public class MapLayer12Dao extends AbstractDao<MapLayer12, Void> {

    public static final String TABLENAME = "MAP_LAYER12";

    /**
     * Properties of entity MapLayer12.<br/>
    ...
    */
    ...
    public MapLayer12Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer12Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER12\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER12\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer12 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer12 readEntity(Cursor cursor, int offset) {
        MapLayer12 entity = new MapLayer12( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer12 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer12 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer12 entity) {
        return null;
    }
