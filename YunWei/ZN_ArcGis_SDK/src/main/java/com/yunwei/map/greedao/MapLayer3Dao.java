...
/**
 * DAO for table "MAP_LAYER3".
*/
public class MapLayer3Dao extends AbstractDao<MapLayer3, Void> {

    public static final String TABLENAME = "MAP_LAYER3";

    /**
     * Properties of entity MapLayer3.<br/>
    ...
    */
    ...
    public MapLayer3Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer3Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER3\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER3\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer3 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer3 readEntity(Cursor cursor, int offset) {
        MapLayer3 entity = new MapLayer3( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer3 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer3 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer3 entity) {
        return null;
    }
