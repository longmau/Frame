...
/**
 * DAO for table "MAP_LAYER14".
*/
public class MapLayer14Dao extends AbstractDao<MapLayer14, Void> {

    public static final String TABLENAME = "MAP_LAYER14";

    /**
     * Properties of entity MapLayer14.<br/>
    ...
    */
    ...
    public MapLayer14Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer14Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER14\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER14\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer14 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer14 readEntity(Cursor cursor, int offset) {
        MapLayer14 entity = new MapLayer14( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer14 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer14 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer14 entity) {
        return null;
    }
