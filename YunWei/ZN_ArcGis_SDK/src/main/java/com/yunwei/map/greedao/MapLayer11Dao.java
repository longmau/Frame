...
/**
 * DAO for table "MAP_LAYER11".
*/
public class MapLayer11Dao extends AbstractDao<MapLayer11, Void> {

    public static final String TABLENAME = "MAP_LAYER11";

    /**
     * Properties of entity MapLayer11.<br/>
    ...
    */
    ...
    public MapLayer11Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer11Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER11\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER11\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer11 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer11 readEntity(Cursor cursor, int offset) {
        MapLayer11 entity = new MapLayer11( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer11 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer11 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer11 entity) {
        return null;
    }
