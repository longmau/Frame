...
/**
 * DAO for table "MAP_LAYER8".
*/
public class MapLayer8Dao extends AbstractDao<MapLayer8, Void> {

    public static final String TABLENAME = "MAP_LAYER8";

    /**
     * Properties of entity MapLayer8.<br/>
    ...
    */
    ...
    public MapLayer8Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer8Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER8\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER8\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer8 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer8 readEntity(Cursor cursor, int offset) {
        MapLayer8 entity = new MapLayer8( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer8 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer8 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer8 entity) {
        return null;
    }
