...
/**
 * DAO for table "MAP_LAYER10".
*/
public class MapLayer10Dao extends AbstractDao<MapLayer10, Void> {

    public static final String TABLENAME = "MAP_LAYER10";

    /**
     * Properties of entity MapLayer10.<br/>
    ...
    */
    ...
    public MapLayer10Dao(DaoConfig config) {
        super(config);
    }
    
    public MapLayer10Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MAP_LAYER10\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MAP_LAYER10\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, MapLayer10 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MapLayer10 readEntity(Cursor cursor, int offset) {
        MapLayer10 entity = new MapLayer10( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MapLayer10 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(MapLayer10 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(MapLayer10 entity) {
        return null;
    }
